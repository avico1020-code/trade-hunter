...
export default function GapUpPage() {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      {/* Header */}
      <StrategyKitHeader title="מרווח למעלה" />
      ...
      <main className="flex-1 relative">
        ...
        <section className="mr-[30%] px-6 py-6">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-3xl font-bold mb-6">מרווח למעלה</h1>
            <p className="text-muted-foreground">תוכן אסטרטגיית מרווח למעלה יוצג כאן.</p>
          </div>
        </section>
