...
export default function DoubleTopPage() {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      {/* Header */}
      <StrategyKitHeader title="כפול עליון" />
      ...
      <main className="flex-1 relative">
        ...
        <section className="mr-[30%] px-6 py-6">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-3xl font-bold mb-6">כפול עליון</h1>
            <p className="text-muted-foreground">תוכן אסטרטגיית כפול עליון יוצג כאן.</p>
          </div>
        </section>
