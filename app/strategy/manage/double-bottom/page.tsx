...
export default function DoubleBottomStrategyPage() {
  const router = useRouter();

  return (
    <div className="min-h-screen flex flex-col bg-background">
      {/* Header */}
      <StrategyKitHeader title="Double Bottom Strategy" backHref="/strategy-kit" />
      ...
      <main className="flex-1 relative">
        ...
        <section className="mr-[30%] px-6 py-6">
          <div className="max-w-7xl mx-auto space-y-6">
            {/* Content */}
            <div>
              <h1 className="text-3xl font-bold mb-6">Double Bottom Strategy</h1>
              <p className="text-muted-foreground">תוכן אסטרטגיית Double Bottom יוצג כאן.</p>
            </div>
          </div>
        </section>
